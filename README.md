...
A responsive React web application that allows users to search for weather information for any city using the API. The app displays the current temperature, humidity, wind speed, and weather conditions with dynamic weather icons.

## Features
- **Search Functionality**: Users can search for any city and get real-time weather data.
- **Weather Information**: Displays temperature, humidity, wind speed, and weather conditions.
- **Dynamic Icons**: Weather icons update based on current weather conditions.
- **Responsive Design**: The app works well across various devices and screen sizes.
